...
void query_planner_init(PlannerInfo* root, mytoydb::parser::Query* parse);
...
void add_base_rels_to_query(PlannerInfo* root, mytoydb::parser::Node* jtnode);
...
void distribute_quals_to_rels(PlannerInfo* root, mytoydb::parser::Node* quals);
