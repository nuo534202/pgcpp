...
// defined in pgcpp/types/ts_types.hpp.
// ---------------------------------------------------------------------------
...
float ts_rank(const pgcpp::types::TsVectorData& vec, const pgcpp::types::TsQueryData& query);
...
float ts_rank_cd(const pgcpp::types::TsVectorData& vec, const pgcpp::types::TsQueryData& query);
...
std::string ts_headline(std::string_view text, const pgcpp::types::TsQueryData& query,
...
struct RewriteRule {
    ...
    pgcpp::types::TsQueryNode replacement;
};

pgcpp::types::TsQueryNode ts_rewrite(const pgcpp::types::TsQueryNode& query,
