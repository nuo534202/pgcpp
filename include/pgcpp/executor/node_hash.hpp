...
struct HashTable {
    ...
    void Insert(uint64_t hash, TupleTableSlot* slot, mytoydb::types::Datum keyval, bool keynull);
    void Clear();
};
...
public:
    ...
    HashTable hashtable;
    std::vector<mytoydb::parser::Node*> hashkeys;  // hash key expressions
